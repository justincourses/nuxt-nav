<template>
  <div class="font-[sans-serif] text-[#333] text-center max-w-xl mx-auto mt-16">
    <svg xmlns="http://www.w3.org/2000/svg" class="w-14 fill-slate-300 inline opacity-50" viewBox="0 0 475.082 475.081">
      <path
    ...
    <div class="mt-8">
      <p class="text-base">Web 开发从入门到上线：全栈开发实战课程</p>
      <p class="text-sm text-gray-600 mt-2">
        一门真正从实践出发的 Web 开发课程，让你快速掌握现代全栈开发技能。
      </p>

      <div class="flex flex-wrap items-center justify-center mt-4">
        <img src="/images/interjc_staff_m.png" alt="Justin's profile picture" class="w-10 h-10 rounded-full" />
        <div class="ml-4 text-left">
          <p class="text-sm font-bold">Justin</p>
          <a href="https://x.com/interjc" target="_blank" rel="noopener noreferrer"
            class="text-xs text-gray-500 hover:text-gray-700 transition-colors" tabindex="0">
            @interjc
          </a>
        </div>
      </div>
...
usePageTitle('关于我们', 'Web开发从入门到上线的全栈开发实战课程，让你快速掌握现代全栈开发技能');
</script>
