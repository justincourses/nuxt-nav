...
应用产品：
- [GitHub Copilot](https://github.com/features/copilot) - Codex 驱动的代码助手
- [OpenAI API](https://platform.openai.com/) - API 访问接口
- [Codex CLI](https://github.com/openai/codex) - 命令行工具
...
学习资源：
- [官方文档](https://openai.com/index/openai-codex/)
- [API 文档](https://platform.openai.com/docs/models)
- [研究论文](https://arxiv.org/abs/2107.03374)
- [GitHub Copilot](https://github.com/features/copilot)
- [开发者社区](https://community.openai.com/)
- [最佳实践](https://platform.openai.com/docs/guides/best-practices)
